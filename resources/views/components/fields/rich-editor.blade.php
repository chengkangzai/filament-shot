<div class="fi-fo-rich-editor" style="border: 1px solid var(--gray-200); border-radius: 0.75rem; overflow: hidden;{{ ($field['disabled'] ?? false) ? ' opacity: 0.5; pointer-events: none;' : '' }}">
