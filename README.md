...
| Light | Dark |
|-------|------|
| ![Form Light](examples/images/form-light.png?v=2) | ![Form Dark](examples/images/form-dark.png?v=2) |

| Section Layout | Grid Layout |
|----------------|-------------|
| ![Form Section](examples/images/form-section.png?v=2) | ![Form Grid](examples/images/form-grid.png?v=2) |

| Additional Field Types |
|------------------------|
| ![Form Fields](examples/images/form-fields.png?v=2) |

### Tables

| Basic | With Badges |
|-------|-------------|
| ![Table Basic](examples/images/table-basic.png?v=2) | ![Table Badges](examples/images/table-badges.png?v=2) |

| Styled (Weight + Mono Font) | Dark Mode |
|------------------------------|-----------|
| ![Table Styled](examples/images/table-styled.png?v=2) | ![Table Dark](examples/images/table-dark.png?v=2) |

| Icon Column (Boolean) |
|-----------------------|
| ![Table Icon Column](examples/images/table-icon-column.png?v=2) |

### Infolist

| Light | Dark |
|-------|------|
| ![Infolist](examples/images/infolist.png?v=2) | ![Infolist Dark](examples/images/infolist-dark.png?v=2) |

### Stats Widgets

| Light | Dark |
|-------|------|
| ![Stats](examples/images/stats.png?v=2) | ![Stats Dark](examples/images/stats-dark.png?v=2) |
